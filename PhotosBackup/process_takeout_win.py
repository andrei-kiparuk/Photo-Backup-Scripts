...
input_directory = r"C:\path\to\Google Takeout"
output_directory = r"C:\path\to\Converted"
processed_directory = r"C:\path\to\Processed"
metadata_failed_log = "metadata_failed.log"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--quality", type=int, default=10, help="Quality setting for video conversion (lower is better).")
    ...
    if args.use_gpu:
        if "hevc_nvenc" in available_encoders:
            ...
            print("Using GPU encoder: hevc_nvenc")
        else:
            video_encoder = "libx265"
            print("hevc_nvenc not available. Falling back to CPU encoder: libx265")
    else:
        video_encoder = "libx265"
