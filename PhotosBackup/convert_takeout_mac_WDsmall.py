...
input_directory = "/Volumes/WDsmall/Icloud"  # Input Google Takeout folder
output_directory = "/Volumes/G-DRIVE/Converted"  # Output folder for converted files
processed_directory = "/Volumes/WDsmall/Processed"  # Folder for original processed files
