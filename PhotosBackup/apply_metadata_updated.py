...
def move_to_date_folder(file_path, target_root):
    # Get the file's modified date or date taken
    file_date = datetime.fromtimestamp(os.path.getmtime(file_path))

    # Ensure the date is before December 6, 2024
    cutoff_date = datetime(2024, 12, 6)
    if file_date >= cutoff_date:
        return

    # Create the folder structure YYYY/MM/DD
