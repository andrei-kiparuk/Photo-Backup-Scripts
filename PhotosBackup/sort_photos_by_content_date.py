...
source_dir = "/Volumes/WDsmall/UnsortedPhotos"
dest_base_dir = "/Volumes/G-DRIVE/sortedphotos"

# Define supported file extensions for photos
supported_extensions = (".jpg", ".jpeg", ".png", ".cr2", ".dng", ".heic", ".tif", ".tiff")
