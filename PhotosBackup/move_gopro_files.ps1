...
$destinationDrive = "D:\GoPro_Backup" # Destination drive/path (e.g., "E:\GoPro_Backup")
$goproFileNamePatterns = @("GOPR*", "GH*", "GX*", "G*") # Filename patterns for GoPro files (e.g., GOPR1234.MP4, GH010123.MP4)
